...
// 				
// 		bEqResult = ((**it_ch) == oExpectedPair);
// 		if (!bEqResult) {
// 			PRT_PAIR_CHK_FAIL((**it_ch), oExpectedPair, iPos);
// 			bResult = false;
// 		}
// 		
...
// 		}
// 		
// 		it_er = std::find(lFoundEqualRange.begin(), lFoundEqualRange.end(), (*it_ch));
// 		if (it_er != lFoundEqualRange.end()) {
// 			PRT_FIND_PAIR_CHK_FAIL((**it_er), (iPos + nRemovedCount))
// 		}
// 		
// 		it_er = std::find(lFoundEqualRangeOp.begin(), lFoundEqualRangeOp.end(), (*it_ch));
